...
delay (wait);
  ...
  for (uint16_t microsec = servo_0; microsec < servo_90; microsec++) {
...
//###################90-180################# 
  ...
  for (uint16_t microsec = servo_90; microsec < servo_180; microsec++) {
    pwm.writeMicroseconds(2, microsec);
    pwm.writeMicroseconds(3, microsec);
    pwm.writeMicroseconds(4, microsec);
    pwm.writeMicroseconds(5, microsec);
...
//###################180-270################# 
  ...
  for (uint16_t microsec = servo_180; microsec < servo_270; microsec++) {
    pwm.writeMicroseconds(2, microsec);
    pwm.writeMicroseconds(3, microsec);
    pwm.writeMicroseconds(4, microsec);
    pwm.writeMicroseconds(5, microsec);
...
//###################270-180################# 
  ...
  delay(500);
  for (uint16_t microsec = servo_270; microsec > servo_180; microsec--) {
    pwm.writeMicroseconds(2, microsec);
    pwm.writeMicroseconds(3, microsec);
    pwm.writeMicroseconds(4, microsec);
    pwm.writeMicroseconds(5, microsec);
  ...
  delay(500);
  for (uint16_t microsec = servo_180; microsec > servo_90; microsec--) {
    pwm.writeMicroseconds(2, microsec);
    pwm.writeMicroseconds(3, microsec);
    pwm.writeMicroseconds(4, microsec);
    pwm.writeMicroseconds(5, microsec);
...
//###################90-0################# 
  ...
  delay(500);
  for (uint16_t microsec = servo_90; microsec > servo_0; microsec--) {
    pwm.writeMicroseconds(2, microsec);
    pwm.writeMicroseconds(3, microsec);
    pwm.writeMicroseconds(4, microsec);
    pwm.writeMicroseconds(5, microsec);
